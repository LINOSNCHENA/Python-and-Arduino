...
BLEByteCharacteristic redLEDCharacteristic("13012F01-F8C3-4F4A-A8F4-15CD926DA146", BLEWrite |BLERead| BLEWriteWithoutResponse);
BLEByteCharacteristic greenLEDCharacteristic("13012F02-F8C3-4F4A-A8F4-15CD926DA146", BLEWrite |BLERead| BLEWriteWithoutResponse);
BLEByteCharacteristic blueLEDCharacteristic("13012F03-F8C3-4F4A-A8F4-15CD926DA146", BLEWrite |BLERead| BLEWriteWithoutResponse);
...
void loop()
{
    ...
    if (central)
    {
        ...
        while (central.connected())
        {
            ...
            {
                if (greenLEDCharacteristic.value())
                { // any non-zero value
            ...
            {
                if (blueLEDCharacteristic.value())
                { // any non-zero value
